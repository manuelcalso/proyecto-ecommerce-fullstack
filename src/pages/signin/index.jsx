            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full rounded-full border-0 py-1.5 px-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 shadow-text-white text-black font-bold"
                  value={user.email}
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block w-full rounded-full border-0 py-1.5 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 shadow-text-white text-black font-bold"
                  value={user.password}
                  onChange={handleChange}
                />
              </div>
