        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg ">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-300 font-bellerose">
              Be the first to discover the latest trends, receive special
              offers, and gain access to valuable tips and tricks. Join our
              community of subscribers who are always one step ahead.
            </p>
